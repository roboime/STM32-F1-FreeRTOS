...
//#include <rf_power_ctrl.h>

class NRF24L01P: public MODEM{
public:
	NRF24L01P(SPI &spi, GPIO_TypeDef *GPIOx_SS, uint16_t GPIO_Pin_SS, GPIO_TypeDef *GPIOx_CE,
	...
	typedef union{
		struct {											//Setup of Automatic Retransmission
			...
			uint8_t ARD:4;									//Auto Retransmit Delay
															...
															//ARD must be 500uS or more, if the ACK payload is more than 5byte in 1Mbps mode the ARD must be
															//500uS or more. In 250kbps mode (even when the payload is not in ACK) the ARD must be 500uS or more.
															...
															//for 250uS (500uS in 250kbps mode) to wait for address match. If the address match is detected, it stays in
